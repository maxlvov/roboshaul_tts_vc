...
class DurationPredictor(BaseModule):
    def __init__(self, in_channels, filter_channels, kernel_size, p_dropout, out_channels=1):
        ...
        self.proj = torch.nn.Conv1d(filter_channels, out_channels, 1)
...
class TextEncoder(BaseModule):
    def __init__(self, n_vocab, n_feats, n_channels, filter_channels, 
                 ...
                 p_dropout, window_size=None, spk_emb_dim=64, n_spks=1, num_dp_output_channels=1):
        ...
        self.proj_w = DurationPredictor(n_channels + (spk_emb_dim if n_spks > 1 else 0), filter_channels_dp, 
                                        kernel_size, p_dropout, out_channels=num_dp_output_channels)
